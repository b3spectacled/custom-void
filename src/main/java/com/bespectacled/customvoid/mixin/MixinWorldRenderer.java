...
public class MixinWorldRenderer {
	...
	@Redirect(
        ...
        at = @At(value = "INVOKE", target = "Lcom/mojang/blaze3d/systems/RenderSystem;color3f(FFF)V", ordinal = 1)
    )
	...
	@Redirect(
        method = "renderSky(Lnet/minecraft/client/util/math/MatrixStack;F)V",
        at = @At(value = "INVOKE", target = "Lnet/minecraft/client/world/ClientWorld$Properties;getSkyDarknessHeight()D") 
    )
